...
public class View_committee extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ResultSet rs = preparedstatement.executeQuery();
					 ...
					 while(rs.next())
					 {
						 Object o[] = {rs.getInt("House_number"),rs.getString("Name"),rs.getString("Phone_Number"),rs.getString("Designation")};
						 t_1.addRow(o);
					 }
				} catch (Exception e2) {
					e2.printStackTrace();
