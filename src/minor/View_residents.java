...
public class View_residents extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ResultSet rs = preparedstatement.executeQuery();
					 ...
					 t_1.addColumn("House_Number");
					 t_1.addColumn("Owner_Name");
					 t_1.addColumn("Phone_Number");
					 t_1.setRowCount(0);
					 while(rs.next())
					 {
						 Object o[] = {rs.getInt("House_Number"),rs.getString("Owner_Name"),rs.getString("Phone_Number")};
						 t_1.addRow(o);
					 }
				} catch (Exception e2) {
					e2.printStackTrace();
